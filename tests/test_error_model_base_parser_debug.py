...
class TestJiraUtilsPrecisionCoverage:
    ...
    def test_parse_jira_tickets_from_storage_with_invalid_json_list(self):
        ...
        invalid_json = '["PROJ-123", "PROJ-456", null, 789]'  # Mixed types including null
...
class TestDebugUtilsPrecisionCoverage:
    ...
    def test_format_debug_output_edge_cases(self):
        """Test format_debug_output with edge cases to hit lines 52, 53."""
        # Test with None input (should hit line 52-53)
        result = format_debug_output(None)
        ...
        result = format_debug_output(complex_data)
        assert isinstance(result, str)
        assert len(result) > 0
    ...
    def test_debug_utilities_comprehensive_coverage(self):
        ...
        with patch('builtins.print') as mock_print:
            for test_case in test_cases:
                ...
                formatted = format_debug_output(test_case)
